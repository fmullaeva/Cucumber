...
public class ElementUtils {
        ...
        public static void clickText(List <WebElement > elements, String text){
    ...
    public static void clickAttribute(List <WebElement > elements, String attribute,String text){
        Iterator<WebElement> iterator = elements.iterator();
        while (iterator.hasNext()) {
            WebElement element = iterator.next();
